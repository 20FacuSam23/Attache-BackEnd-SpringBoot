...
@CrossOrigin(origins="https://web-app-a49e2.web.app")
public class PersonaController {

    @Autowired
    private ImplPersonaService personaService;
    ...
    @PostMapping("/create")
    public ResponseEntity<?> delete(@RequestBody dtoPersona dtopersona) {
